...
body {
    ...
    * {
    ...
    #red-ui-navigator-canvas {
        background-color: rgb(118 117 117 / 80%);
    }

    .red-ui-sidebar-help-toc>.red-ui-treeList>.red-ui-treeList-container>.red-ui-editableList>.red-ui-editableList-container>ol>li:first-child {
        display: none;
    }
