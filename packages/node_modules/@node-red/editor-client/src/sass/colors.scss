...
$primary-background: #292929; //#0ff;

$secondary-background: #1b1c1e; //#ff0;
$secondary-background-selected: #202123; //#e9e900;
$secondary-background-inactive: #393a3b; //#f0f000;
$secondary-background-hover: #4b515d; //#dd0;
$secondary-background-disabled: #f9f9f9; //#fafa0;

$third-background: #202123; //#ff0;
$tertiary-background: #595959; //#f0f;

$shadow: rgba(0, 0, 0, 0.2);

// Main body text
$primary-text-color: #EDEBE9; //#0f0;
// UI control label text
$secondary-text-color: #BEBBB8; //#00f;
$secondary-text-color-focus: #fff; //#009;
$secondary-text-color-hover: #fff; //#006;
$secondary-text-color-active: #fff; //#006;
$secondary-text-color-selected: #fff; //#00A;
$secondary-text-color-inactive: #fff; //#006;
$secondary-text-color-disabled: #bbb; //#00C;
$secondary-text-color-disabled-active: #666; //#009;
$secondary-text-color-disabled-inactive: #666; //#00A;

// UI control node label text
$third-text-color: #000; //#00f;
$third-text-color-focus: #40a9ff; //#009;
$third-text-color-hover: #40a9ff; //#006;
$third-text-color-active: #0050b3; //#006;
$third-text-color-selected: #0050b3; //#00A;
$third-text-color-inactive: #1890ff; //#006;
$third-text-color-disabled: #bae7ff; //#00C;
$third-text-color-disabled-active: #e6f7ff; //#009;
$third-text-color-disabled-inactive: #e6f7ff; //#00A;

// Sub label text
$tertiary-text-color: #aaa; //#90f;
// Heading text
$header-text-color: $primary-text-color; //#f00;

$text-color-error: #cf0002;
$text-color-warning: #fab563;
$text-color-success: #59a600;
$text-color-code: #cf0002;
$text-color-link: #3794ff;


$primary-border-color: #292929; //#f00;
$secondary-border-color: #393a3b !important; //#0f0;
$tertiary-border-color: #393c42; //#00f;
...
$list-item-background-selected: #263c42; // #fff1e5;
...
$tab-background-active: #1b1c1e;
$tab-background-selected: #1b1c1e;
$tab-background-inactive: $secondary-background-inactive;
$tab-background-hover: $secondary-background-hover;

$palette-header-background: $secondary-background;
...
$workspace-button-background-primary: #106ebe;
$workspace-button-background-primary-hover: #0e62ac;
...
$view-grid-color: #493c3c;

$node-label-color: $third-text-color;
...
$deploy-button-color: #edebe9;
$deploy-button-color-active: #edebe9;
$deploy-button-color-disabled: #edebe9;
$deploy-button-background: #106ebe;
$deploy-button-background-hover: #0e62ac;
$deploy-button-background-active: #0e62ac;
$deploy-button-background-disabled: #595959;
$deploy-button-background-disabled-hover: #595959;
