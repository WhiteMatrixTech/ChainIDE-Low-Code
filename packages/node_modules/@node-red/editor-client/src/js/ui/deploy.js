...
RED.deploy = (function() {
    ...
    function init(options) {
        ...
        $('<li><div class="red-ui-external-button-group button-group">' +
            '<a id="red-ui-header-button-k8s" class="red-ui-k8s-button" target="_blank" href="https://dashboard.gateway-beta.chainide.com/">' +
            '<span class="red-ui-deploy-button-content"> ' +
            '<img id="red-ui-header-button-deploy-icon" width="97" height="18" src="red/images/k8s.svg">' +
            '</span></a></div></li>').prependTo(".red-ui-header-toolbar")

        $('<li><div class="red-ui-external-button-group button-group">' +
            '<a id="red-ui-header-button-istio" class="red-ui-istio-button" target="_blank" href="https://gateway-beta.chainide.com/kiali">' +
            '<img id="red-ui-header-button-deploy-icon" width="24" height="24" src="red/images/istio.svg">' +
            '<span class="red-ui-istio-button-content">Istio</span>' +
            '</a></div></li>').prependTo(".red-ui-header-toolbar");
