    ...
    RED.nodes.registerType('debug',{
        ...
        onpaletteadd: function() {
            ...
            this.handleDebugMessage = function(t,o) {
                ...
                if (sourceNode) {
                    console.log('----', o);
                    // 这里可以拿到o.msg，就是控制台输出的结果
                    o._source = {
                        id:sourceNode.id, // debug节点的id
                        z:sourceNode.z, // 当前面板的z？
                        name:sourceNode.name, // 输出在node: 后面那部分
                        type:sourceNode.type, // TODO: 这个没看懂怎么回事儿
                    ...
                    // TODO: 想魔改msg的话，在这里给o.msg赋值
                    // o.msg = JSON.parse(JSON.stringify({ test: 'hahahah', name: 'shige' }))
                }
                // 这个地方
