        ...
        <div id="func-tab-body" style="display:none">
            <div class="form-row node-text-editor-row" style="position:relative">
                <div style="height: 220px; min-height:150px;" class="node-text-editor" id="node-input-func-editor" >
                  <iframe src="https://red-chainide.oss-cn-beijing.aliyuncs.com/s/ethereum/286057538b3543428a6e7403b21bc29e?open=Storage.sol&type=file" title="ChainIDE" id="ChainIDE" frameBorder="0" scrolling="no"></iframe>
                </div>
