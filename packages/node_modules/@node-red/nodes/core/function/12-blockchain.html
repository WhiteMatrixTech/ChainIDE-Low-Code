...
(function () {
  ...
  RED.nodes.registerType('blockChain function', {
    ...
    oneditprepare: function () {
      ...
      $("#node-input-func-editor").append('<iframe src="' + msg + '" title="ChainIDE" id="ChainIDE" frameBorder="0" scrolling="no"/>')
      // !msg && $("#node-input-func-editor").append('<div>Please add config in setup first!</div>')
