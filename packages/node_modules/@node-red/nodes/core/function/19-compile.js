    ...
    async function compileContract(msg) {
        ...
        const response = new Promise(function (resolve, reject) {
            try {
                ...
                // 可以强行直接用最新版本去编译，注意上传的合约里面暂时都要设置一下最高版本
    ...
    function CompileNode(n) {
        ...
        node.on("input", function (msg, send, done) {
            if (state === RESOLVING) {
                ...
                compileContract(msg)
                    .then(function(res) {
                        msg.compileResult = 'compile success';
                        console.log('compile success', res);
                    })
                    .catch(function(err) {
                        msg.compileResult = 'compile error';
