...
module.exports = function(RED) {
    ...
    function FunctionNode(n) {
        ...
        node.on("input", function(msg,send,done) {
            ...
            if(state === RESOLVING) {
                console.log('function ing', msg);
                messages.push({msg:msg, send:send, done:done});
            }
            else if(state === RESOLVED) {
                console.log('function done', msg);
        ...
        Promise.all(moduleLoadPromises).then(() => {
            ...
            try {
                ...
                processMessage = function (msg, send, done) {
                    console.log('in process message', msg);
                    ...
                    context.results.then(function(results) {
                        console.log('in context results', results);
                ...
                promise.then(function (v) {
                    ...
                    while (msgs.length > 0) {
                        msgs.forEach(function (s) {
                            console.log('send message', s.msg);
